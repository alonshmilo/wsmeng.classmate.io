...
<body>
	<div class=" all_660">
		<%
			String message = (String)session.getAttribute("gapMessage");
			if(message!=null){
		%>
		<%= message %><br/>
		<%
			session.removeAttribute("gapMessage");
			}
		%>
		<div class="xxk_box">
			<ul class="xxk_title">
			...
			<div class="xxk_conn">
				<form action="<%= request.getContextPath() %>/PostGapQuestionServlet" method="post">
